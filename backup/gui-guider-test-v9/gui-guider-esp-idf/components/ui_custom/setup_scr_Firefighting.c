...
void setup_scr_Firefighting(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->Firefighting, 320, 240);
    ...
    lv_obj_set_style_bg_image_src(ui->Firefighting, &_sub_page_bak_RGB565A8_320x240, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_cont_smoke, 18, 36);
    lv_obj_set_size(ui->Firefighting_cont_smoke, 150, 90);
    ...
    lv_obj_set_style_radius(ui->Firefighting_cont_smoke, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_smoke_tit, 14, 14);
    lv_obj_set_size(ui->Firefighting_label_smoke_tit, 65, 10);
    ...
    lv_obj_set_pos(ui->Firefighting_label_status, 116, 15);
    lv_obj_set_size(ui->Firefighting_label_status, 20, 8);
    ...
    lv_obj_set_pos(ui->Firefighting_led_status, 110, 18);
    lv_obj_set_size(ui->Firefighting_led_status, 2, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_img_smoke, 12, 28);
    lv_obj_set_size(ui->Firefighting_img_smoke, 36, 36);
    lv_obj_add_flag(ui->Firefighting_img_smoke, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->Firefighting_img_smoke, &_menu_electricity_RGB565A8_36x36);
    ...
    lv_obj_set_pos(ui->Firefighting_label_desc, 51, 33);
    lv_obj_set_size(ui->Firefighting_label_desc, 86, 10);
    ...
    lv_obj_set_pos(ui->Firefighting_line_1, 92, 53);
    lv_obj_set_size(ui->Firefighting_line_1, 2, 20);
    static lv_point_precise_t Firefighting_line_1[] = {{0, 0},{0, 15}};
    ...
    lv_obj_set_pos(ui->Firefighting_label_warning, 60, 49);
    lv_obj_set_size(ui->Firefighting_label_warning, 20, 15);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_warning, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_warning_tit, 60, 66);
    lv_obj_set_size(ui->Firefighting_label_warning_tit, 24, 8);
    ...
    lv_obj_set_pos(ui->Firefighting_label_alert_tit, 104, 66);
    lv_obj_set_size(ui->Firefighting_label_alert_tit, 24, 8);
    ...
    lv_obj_set_pos(ui->Firefighting_label_alert, 104, 49);
    lv_obj_set_size(ui->Firefighting_label_alert, 20, 15);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_alert, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_cont_temp, 18, 131);
    lv_obj_set_size(ui->Firefighting_cont_temp, 150, 90);
    ...
    lv_obj_set_style_radius(ui->Firefighting_cont_temp, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_7, 14, 14);
    lv_obj_set_size(ui->Firefighting_label_7, 65, 10);
    ...
    lv_obj_set_pos(ui->Firefighting_label_6, 116, 15);
    lv_obj_set_size(ui->Firefighting_label_6, 20, 8);
    ...
    lv_obj_set_pos(ui->Firefighting_led_1, 110, 18);
    lv_obj_set_size(ui->Firefighting_led_1, 2, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_img_1, 12, 28);
    lv_obj_set_size(ui->Firefighting_img_1, 36, 36);
    lv_obj_add_flag(ui->Firefighting_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->Firefighting_img_1, &_menu_tem_RGB565A8_36x36);
    ...
    lv_obj_set_pos(ui->Firefighting_label_5, 51, 33);
    lv_obj_set_size(ui->Firefighting_label_5, 86, 10);
    ...
    lv_obj_set_pos(ui->Firefighting_line_2, 92, 53);
    lv_obj_set_size(ui->Firefighting_line_2, 2, 20);
    static lv_point_precise_t Firefighting_line_2[] = {{0, 0},{0, 15}};
    ...
    lv_obj_set_pos(ui->Firefighting_label_heigh, 59, 48);
    lv_obj_set_size(ui->Firefighting_label_heigh, 20, 15);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_heigh, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_3, 60, 66);
    lv_obj_set_size(ui->Firefighting_label_3, 28, 9);
    ...
    lv_obj_set_pos(ui->Firefighting_label_2, 104, 66);
    lv_obj_set_size(ui->Firefighting_label_2, 25, 8);
    ...
    lv_obj_set_pos(ui->Firefighting_label_low, 104, 49);
    lv_obj_set_size(ui->Firefighting_label_low, 20, 15);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_low, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_cont_1, 177, 36);
    lv_obj_set_size(ui->Firefighting_cont_1, 137, 185);
    ...
    lv_obj_set_style_radius(ui->Firefighting_cont_1, 7, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_security, 10, 12);
    lv_obj_set_size(ui->Firefighting_label_security, 65, 10);
    ...
    lv_obj_set_pos(ui->Firefighting_label_temp_alert, 12, 26);
    lv_obj_set_size(ui->Firefighting_label_temp_alert, 34, 7);
    ...
    lv_obj_set_pos(ui->Firefighting_bar_temp, 49, 28);
    lv_obj_set_size(ui->Firefighting_bar_temp, 88, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_bar_smoke, 49, 40);
    lv_obj_set_size(ui->Firefighting_bar_smoke, 88, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_label_8, 12, 38);
    lv_obj_set_size(ui->Firefighting_label_8, 34, 7);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_8, &lv_font_arial_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_9, 12, 51);
    lv_obj_set_size(ui->Firefighting_label_9, 34, 7);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_9, &lv_font_arial_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_bar_alert, 49, 53);
    lv_obj_set_size(ui->Firefighting_bar_alert, 88, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_bar_other, 49, 65);
    lv_obj_set_size(ui->Firefighting_bar_other, 88, 2);
    ...
    lv_obj_set_pos(ui->Firefighting_label_10, 12, 63);
    lv_obj_set_size(ui->Firefighting_label_10, 34, 7);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_10, &lv_font_arial_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_11, 10, 80);
    lv_obj_set_size(ui->Firefighting_label_11, 78, 10);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_label_11, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_chart_power, 17, 94);
    lv_obj_set_size(ui->Firefighting_chart_power, 110, 71);
    ...
    lv_obj_set_pos(ui->Firefighting_btn_home, 0, 98);
    lv_obj_set_size(ui->Firefighting_btn_home, 17, 42);
    ...
    lv_obj_set_style_radius(ui->Firefighting_btn_home, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Firefighting_btn_home, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_image_src(ui->Firefighting_btn_home, &_home_bak_RGB565A8_17x42, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Firefighting_btn_home, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Firefighting_label_title, 88, 7);
    lv_obj_set_size(ui->Firefighting_label_title, 144, 19);
    ...
    lv_obj_set_pos(ui->Firefighting_digital_clock_time, 276, 5);
    lv_obj_set_size(ui->Firefighting_digital_clock_time, 39, 15);
    ...
    lv_obj_set_pos(ui->Firefighting_datetext_date, 251, 5);
    lv_obj_set_size(ui->Firefighting_datetext_date, 39, 18);
    ...
    lv_obj_set_pos(ui->Firefighting_img_logo, 14, 6);
    lv_obj_set_size(ui->Firefighting_img_logo, 24, 10);
    lv_obj_add_flag(ui->Firefighting_img_logo, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->Firefighting_img_logo, &_white_logo_RGB565A8_24x10);
