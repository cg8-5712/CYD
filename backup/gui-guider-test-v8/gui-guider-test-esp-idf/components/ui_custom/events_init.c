...
static void Home_event_handler (lv_event_t *e)
{
    ...
    {
        lv_img_set_pivot(guider_ui.Home_img_fan, 18, 19);
        ui_animation(guider_ui.Home_img_fan, 1000, 0, lv_img_get_angle(guider_ui.Home_img_fan), 360*10, &lv_anim_path_linear, -1, 0, 0, 0, (lv_anim_exec_xcb_t)lv_img_set_angle, NULL, NULL, NULL);
        home_task = lv_timer_create(home_timer_cb, 80, &guider_ui);
        
        // Delete all animations
        lv_anim_del(guider_ui.Home_img_fan, (lv_anim_exec_xcb_t)lv_img_set_angle);
        lv_anim_del(guider_ui.Home_img_snow, (lv_anim_exec_xcb_t)lv_obj_set_y);
        lv_anim_del(guider_ui.Home_img_snow_1, (lv_anim_exec_xcb_t)lv_obj_set_y);
        lv_anim_del(guider_ui.Home_img_snow_2, (lv_anim_exec_xcb_t)lv_obj_set_y);
        break;
    }
...
static void Home_sw_air_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        case (true):
        {
            lv_obj_set_style_img_recolor(guider_ui.Home_img_air, lv_color_hex(0x0ae687), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_fan, lv_color_hex(0xbefd12), LV_PART_MAIN);
            
            // Recreate fan rotation animation
            ui_animation(guider_ui.Home_img_fan, 1000, 0, lv_img_get_angle(guider_ui.Home_img_fan), 360*10, &lv_anim_path_linear, -1, 0, 0, 0, (lv_anim_exec_xcb_t)lv_img_set_angle, NULL, NULL, NULL);
            
            // Recreate snow animations
            ...
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow, lv_color_hex(0xc7f0cf), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow_2, lv_color_hex(0x8deca0), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow_1, lv_color_hex(0x5dee9c), LV_PART_MAIN);
            break;
        }
        case (false):
        {
            lv_obj_set_style_img_recolor(guider_ui.Home_img_fan, lv_color_hex(0xb1aaaa), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_air, lv_color_hex(0xc1b8b8), LV_PART_MAIN);
            ...
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow, lv_color_hex(0xa7aaa7), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow_2, lv_color_hex(0x959796), LV_PART_MAIN);
            lv_obj_set_style_img_recolor(guider_ui.Home_img_snow_1, lv_color_hex(0xa7a9a9), LV_PART_MAIN);
            break;
        }
        default:
            break;
...
static void Home_sw_light_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_VALUE_CHANGED:
    {
        ...
        case (true):
        {
            lv_obj_set_style_img_recolor(guider_ui.Home_img_light, lv_color_hex(0x05ff93), LV_PART_MAIN);
        ...
        case (false):
        {
            lv_obj_set_style_img_recolor(guider_ui.Home_img_light, lv_color_hex(0xa0aba6), LV_PART_MAIN);
...
static void Electricity_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_SCREEN_LOADED:
    {
        ui_animation(guider_ui.Electricity_cont_1, 1000, 0, lv_obj_get_y(guider_ui.Electricity_cont_1), 60, &lv_anim_path_bounce, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_5, 1000, 800, lv_obj_get_y(guider_ui.Electricity_cont_5), 130, &lv_anim_path_bounce, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_4, 1500, 1000, lv_obj_get_y(guider_ui.Electricity_cont_4), 220, &lv_anim_path_bounce, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_3, 1200, 400, lv_obj_get_y(guider_ui.Electricity_cont_3), 110, &lv_anim_path_bounce, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        ui_animation(guider_ui.Electricity_cont_2, 1000, 1000, lv_obj_get_y(guider_ui.Electricity_cont_2), 400, &lv_anim_path_bounce, 0, 0, 0, 0, (lv_anim_exec_xcb_t)lv_obj_set_y, NULL, NULL, NULL);
        break;
    }
    default:
        break;
...
static void Electricity_cont_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        lv_obj_clear_flag(guider_ui.Electricity_cont_info_box, LV_OBJ_FLAG_HIDDEN);
        break;
    }
    default:
        break;
