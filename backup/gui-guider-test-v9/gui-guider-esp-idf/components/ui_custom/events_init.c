...
static void Home_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_SCREEN_LOADED:
    {
        ...
        // Create animations but don't start them
        lv_anim_t a;
        lv_anim_init(&a);
        
        // Fan animation
        lv_anim_set_var(&a, guider_ui.Home_img_fan);
        ...
        // Snow animations
        lv_anim_set_var(&a, guider_ui.Home_img_snow);
        lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)lv_obj_set_y);
        lv_anim_start(&a);
        lv_anim_pause(&a);

        lv_anim_set_var(&a, guider_ui.Home_img_snow_1);
        lv_anim_start(&a);
        lv_anim_pause(&a);

        lv_anim_set_var(&a, guider_ui.Home_img_snow_2);
        lv_anim_start(&a);
        lv_anim_pause(&a);
        break;
    }
...
static void Home_sw_air_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ...
        case (true):
        {
            ...
            // Snow animations with different parameters
            lv_anim_set_var(&a, guider_ui.Home_img_snow);
            lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)lv_obj_set_y);
            lv_anim_set_time(&a, 1000);
            lv_anim_set_values(&a, lv_obj_get_y(guider_ui.Home_img_snow), 160);
            lv_anim_start(&a);
            
            lv_anim_set_var(&a, guider_ui.Home_img_snow_1);
            lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)lv_obj_set_y);
            lv_anim_set_time(&a, 1000);
            lv_anim_set_values(&a, lv_obj_get_y(guider_ui.Home_img_snow_1), 160);
            lv_anim_start(&a);
            
            lv_anim_set_var(&a, guider_ui.Home_img_snow_2);
            lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)lv_obj_set_y);
            lv_anim_set_time(&a, 1000);
            lv_anim_set_values(&a, lv_obj_get_y(guider_ui.Home_img_snow_2), 160);
            lv_anim_start(&a);

            // Rest of color settings remain unchanged
        ...
        case (false):
        {
            // Stop animations by creating new paused animations
            lv_anim_t a;
            lv_anim_init(&a);
            
            // Set common parameters for all animations
            ...
            // Stop all animations on the objects
            lv_anim_del(guider_ui.Home_img_fan, NULL);
            lv_anim_del(guider_ui.Home_img_snow, NULL);
            lv_anim_del(guider_ui.Home_img_snow_1, NULL);
            lv_anim_del(guider_ui.Home_img_snow_2, NULL);

            // ...rest of the existing case (false) code...
            break;
        }
        default:
            break;
