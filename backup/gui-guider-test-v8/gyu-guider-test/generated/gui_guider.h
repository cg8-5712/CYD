...
LV_IMG_DECLARE(_sub_page_bak_320x240);
LV_IMG_DECLARE(_air_alpha_53x28);
LV_IMG_DECLARE(_air_fan_alpha_14x19);
LV_IMG_DECLARE(_menu_light_alpha_28x34);
LV_IMG_DECLARE(_air_snow_alpha_8x8);
LV_IMG_DECLARE(_air_snow_alpha_6x6);
LV_IMG_DECLARE(_air_snow_alpha_4x4);
LV_IMG_DECLARE(_temp_alpha_17x17);
LV_IMG_DECLARE(_Humidity_alpha_13x18);
LV_IMG_DECLARE(_menu_icon_bak_alpha_36x36);
LV_IMG_DECLARE(_menu_icon_bak_alpha_36x36);
LV_IMG_DECLARE(_menu_icon_bak_alpha_36x36);

LV_IMG_DECLARE(_home_bak_18x42);
LV_IMG_DECLARE(_white_logo_alpha_24x10);

LV_IMG_DECLARE(_menu_bak_320x240);
LV_IMG_DECLARE(_menu_bal_alpha_128x128);

LV_IMG_DECLARE(_menu_air_36x36);

LV_IMG_DECLARE(_menu_anfang_36x36);

LV_IMG_DECLARE(_menu_elevator_36x36);

LV_IMG_DECLARE(_menu_tem_36x36);

LV_IMG_DECLARE(_menu_xiaofang_36x36);

LV_IMG_DECLARE(_menu_electricity_36x36);

LV_IMG_DECLARE(_menu_light_36x36);

LV_IMG_DECLARE(_sub_page_bak_320x240);
LV_IMG_DECLARE(_menu_electricity_alpha_36x36);
LV_IMG_DECLARE(_menu_tem_alpha_36x36);

LV_IMG_DECLARE(_home_bak_17x42);
LV_IMG_DECLARE(_white_logo_alpha_24x10);
...
LV_IMG_DECLARE(_rect_bak_192x160);
LV_IMG_DECLARE(_temp_alpha_17x17);
LV_IMG_DECLARE(_temp_alpha_17x17);
LV_IMG_DECLARE(_temp_alpha_17x17);
