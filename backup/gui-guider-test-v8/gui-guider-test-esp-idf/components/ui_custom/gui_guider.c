...
#include "esp_log.h"
static const char *TAG = "GUI-GUIDER";
...
void setup_ui(lv_ui *ui)
{
    ...
    ESP_LOGI(TAG, "scr_del_flayg: Home_del=%d, Firefighting_del=%d, Electricity_del=%d", ui->Home_del, ui->Firefighting_del, ui->Electricity_del);
    ESP_LOGI(TAG, "SCR_DEL_FLAY init done");
    init_keyboard(ui);
    ESP_LOGI(TAG, "Keyboard init done");
    ESP_LOGI(TAG, "Setup Home screen");
    setup_scr_Home(ui);
    ESP_LOGI(TAG, "Home setup done");
    lv_scr_load(ui->Home);
}
