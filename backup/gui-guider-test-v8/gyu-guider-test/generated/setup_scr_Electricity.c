...
void setup_scr_Electricity(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity, &_sub_page_bak_320x240, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_btn_home, &_home_bak_17x42, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Electricity_cont_1, 104, 280);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_1, &_pos_80x32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Electricity_label_1, 28, 12);
    lv_obj_set_size(ui->Electricity_label_1, 36, 8);
    ...
    lv_obj_set_pos(ui->Electricity_label_2, 4, 10);
    lv_obj_set_size(ui->Electricity_label_2, 19, 11);
    ...
    lv_obj_set_pos(ui->Electricity_cont_2, 112, -50);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_2, &_pos_80x32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->Electricity_label_4, 36, 9);
    ...
    lv_obj_set_pos(ui->Electricity_label_3, 4, 10);
    lv_obj_set_size(ui->Electricity_label_3, 20, 11);
    ...
    lv_obj_set_pos(ui->Electricity_cont_3, 12, 255);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_3, &_pos_80x32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Electricity_label_6, 30, 12);
    lv_obj_set_size(ui->Electricity_label_6, 34, 10);
    ...
    lv_obj_set_pos(ui->Electricity_label_5, 3, 11);
    lv_obj_set_size(ui->Electricity_label_5, 21, 13);
    ...
    lv_obj_set_pos(ui->Electricity_cont_4, 140, -110);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_4, &_pos_80x32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Electricity_label_8, 29, 12);
    lv_obj_set_size(ui->Electricity_label_8, 37, 9);
    ...
    lv_obj_set_size(ui->Electricity_label_7, 20, 12);
    ...
    lv_obj_set_pos(ui->Electricity_cont_5, 224, 265);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_5, &_pos_80x32, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->Electricity_label_10, 32, 10);
    ...
    lv_obj_set_pos(ui->Electricity_label_9, 6, 11);
    lv_obj_set_size(ui->Electricity_label_9, 16, 14);
    ...
    lv_img_set_src(ui->Electricity_img_logo, &_white_logo_alpha_24x10);
    ...
    lv_obj_set_style_bg_img_src(ui->Electricity_cont_info, &_rect_bak_192x160, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Electricity_img_2 = lv_img_create(ui->Electricity_cont_13);
    lv_obj_add_flag(ui->Electricity_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Electricity_img_2, &_temp_alpha_17x17);
    lv_img_set_pivot(ui->Electricity_img_2, 50,50);
    lv_img_set_angle(ui->Electricity_img_2, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Electricity_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Electricity_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Electricity_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Electricity_img_2, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Electricity_img_3 = lv_img_create(ui->Electricity_cont_14);
    lv_obj_add_flag(ui->Electricity_img_3, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Electricity_img_3, &_temp_alpha_17x17);
    lv_img_set_pivot(ui->Electricity_img_3, 50,50);
    lv_img_set_angle(ui->Electricity_img_3, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Electricity_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Electricity_img_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Electricity_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Electricity_img_3, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->Electricity_img_4 = lv_img_create(ui->Electricity_cont_15);
    lv_obj_add_flag(ui->Electricity_img_4, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Electricity_img_4, &_temp_alpha_17x17);
    lv_img_set_pivot(ui->Electricity_img_4, 50,50);
    lv_img_set_angle(ui->Electricity_img_4, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Electricity_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Electricity_img_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Electricity_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Electricity_img_4, true, LV_PART_MAIN|LV_STATE_DEFAULT);
