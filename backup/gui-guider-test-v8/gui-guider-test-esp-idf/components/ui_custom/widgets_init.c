...
void Home_digital_clock_time_timer(lv_timer_t *timer)
{
    ...
    {
        lv_label_set_text_fmt(guider_ui.Home_digital_clock_time, "%d:%02d:%02d", 
            Home_digital_clock_time_hour_value, 
            Home_digital_clock_time_min_value, 
            Home_digital_clock_time_sec_value);
    }
}
...
void Firefighting_digital_clock_time_timer(lv_timer_t *timer)
{
    ...
    {
        lv_label_set_text_fmt(guider_ui.Firefighting_digital_clock_time, "%d:%02d:%02d", 
            Firefighting_digital_clock_time_hour_value, 
            Firefighting_digital_clock_time_min_value, 
            Firefighting_digital_clock_time_sec_value);
    }
}
...
void Electricity_digital_clock_time_timer(lv_timer_t *timer)
{
    ...
    {
        lv_label_set_text_fmt(guider_ui.Electricity_digital_clock_time, "%d:%02d:%02d", 
            Electricity_digital_clock_time_hour_value, 
            Electricity_digital_clock_time_min_value, 
            Electricity_digital_clock_time_sec_value);
    }
}
