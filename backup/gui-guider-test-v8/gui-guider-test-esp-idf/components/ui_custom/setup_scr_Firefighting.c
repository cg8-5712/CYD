...
void setup_scr_Firefighting(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(ui->Firefighting, &_sub_page_bak_320x240, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->Firefighting_img_smoke, &_menu_electricity_alpha_36x36);
    ...
    static lv_point_t Firefighting_line_1[] = {{0, 0},{0, 15},};
    ...
    lv_img_set_src(ui->Firefighting_img_1, &_menu_tem_alpha_36x36);
    ...
    static lv_point_t Firefighting_line_2[] = {{0, 0},{0, 15},};
    ...
    lv_obj_set_style_bg_img_src(ui->Firefighting_btn_home, &_home_bak_17x42, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    // Replace the digital clock code with:
    ...
    lv_img_set_src(ui->Firefighting_img_logo, &_white_logo_alpha_24x10);
