...
LV_IMAGE_DECLARE(_sub_page_bak_RGB565A8_320x240);
LV_IMAGE_DECLARE(_air_RGB565A8_53x28);
LV_IMAGE_DECLARE(_air_fan_RGB565A8_14x19);
LV_IMAGE_DECLARE(_menu_light_RGB565A8_28x34);
LV_IMAGE_DECLARE(_air_snow_RGB565A8_8x8);
LV_IMAGE_DECLARE(_air_snow_RGB565A8_6x6);
LV_IMAGE_DECLARE(_air_snow_RGB565A8_4x4);
LV_IMAGE_DECLARE(_temp_RGB565A8_17x17);
LV_IMAGE_DECLARE(_Humidity_RGB565A8_13x18);
LV_IMAGE_DECLARE(_menu_icon_bak_RGB565A8_36x36);

LV_IMAGE_DECLARE(_home_bak_RGB565A8_18x42);
LV_IMAGE_DECLARE(_white_logo_RGB565A8_24x10);

LV_IMAGE_DECLARE(_menu_bak_RGB565A8_320x240);
LV_IMAGE_DECLARE(_menu_bal_RGB565A8_128x128);

LV_IMAGE_DECLARE(_menu_air_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_anfang_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_elevator_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_tem_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_xiaofang_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_electricity_RGB565A8_36x36);

LV_IMAGE_DECLARE(_menu_light_RGB565A8_36x36);

LV_IMAGE_DECLARE(_home_bak_RGB565A8_17x42);

LV_IMAGE_DECLARE(_pos_RGB565A8_80x32);

LV_IMAGE_DECLARE(_rect_bak_RGB565A8_192x160);
