...
// Add this to your custom.c:
void update_clock_time(lv_timer_t * timer) {
    // Get current time
    ...
    // Update label
    lv_label_set_text(guider_ui.Home_digital_clock_time, timestr);
}

// Create timer in setup:

void custom_init(lv_ui *ui)
{
    /* Add your codes here */
    lv_timer_create(update_clock_time, 1000, NULL);
}
